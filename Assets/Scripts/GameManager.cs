...
public class GameManager : MonoBehaviour
{
	...
	IEnumerator SendPendingDrawDetailsCoroutine()
	{
		...
		UnityWebRequest www = UnityWebRequest.PostWwwForm(drawDetailsLink, drawDetailsJson);
	...
	IEnumerator BookTicketCoroutine()
	{
		...
		UnityWebRequest www = UnityWebRequest.PostWwwForm(bookTicketLink, bookTicketDetailsJson);
