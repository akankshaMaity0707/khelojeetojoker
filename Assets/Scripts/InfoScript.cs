...
public class InfoScript : MonoBehaviour
{
	...
	IEnumerator GetTicketDetailsCoroutine()
	{
		...
		UnityWebRequest www = UnityWebRequest.PostWwwForm(ticketDetailsLink, sendToViewTicketDetailsJson);
	...
	IEnumerator GetUserPlayDetailsForTicketCoroutine(string ticketID)
	{
		...
		UnityWebRequest www = UnityWebRequest.PostWwwForm(userPlayDetailsLink, sendTicketDetailsJson);
	...
	IEnumerator GetDateWiseResultsCoroutine()
	{
		...
		UnityWebRequest www = UnityWebRequest.PostWwwForm(resultDetailsLink, sendDateWiseResultJson);
	...
	IEnumerator GetDateWiseReportCoroutine()
	{
		...
		UnityWebRequest www = UnityWebRequest.PostWwwForm(reportDetailsLink, sendReportDetailsJson);
